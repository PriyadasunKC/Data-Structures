...
class Graph {
    ...
    // Function to search for a given vertex and show if it exists in the graph or not
    public void searchVertex(int vertex) {
        if (vertex >= 0 && vertex < numVertices) {
            System.out.println("Vertex " + vertex + " exists in the graph.");
        } else {
...
public class BFS_Search_Given_Vertex {
    public static void main(String[] args) {
        ...
        g.bfs(2);
        System.out.println();
        g.searchVertex(3); // Search for vertex 3
    }
}